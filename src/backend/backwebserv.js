...
instance.delete("/api/tempuser/delete", function(request, response) {
  var prd = { uid: request.params.id };
  var tokenReceived = request.headers.authorization.split(" ")[1];
  jwt.verify(tokenReceived, instance.get("jwtSecret"), function(err, decoded) {
    console.log("in verify");
    if (err) {
      ...
      request.decoded = decoded;
      tempUserModel.deleteOne(prd, function(err, res) {
        if (err) {
          response.statusCode = 500;
          response.send({ status: response.statusCode, error: err });
        }
...
var personFindModel = mongoose.model("personfind", personFindOneSchema, "person");
instance.post("/api/person/findone", function(request, response) {
  var tokenReceived = request.headers.authorization.split(" ")[1];
  jwt.verify(tokenReceived, instance.get("jwtSecret"), function(err, decoded) {
    console.log("in verify");
    if (err) {
      ...
      personFindModel.findOne({PersonalUniqueId:per.PersonalUniqueId}).exec(function(err, res) {
        if (err) {
          response.statusCode = 500;
          response.send({ status: response.statusCode, error: err });
        }
...
var personTempFindModel = mongoose.model("persontempfind", personTempFindOneSchema, "tempPerson");
instance.post("/api/tempperson/findone", function(request, response) {
  var tokenReceived = request.headers.authorization.split(" ")[1];
  jwt.verify(tokenReceived, instance.get("jwtSecret"), function(err, decoded) {
    console.log("in verify");
    if (err) {
      ...
      console.log(per.PersonalUniqueId);
      personTempFindModel.findOne({PersonalUniqueId:per.PersonalUniqueId}).exec(function(err, res) {
        if (err) {
          response.statusCode = 500;
          response.send({ status: response.statusCode, error: err });
        }
...
instance.post("/api/ustatus/create", function(request, response) {
  var tokenReceived = request.headers.authorization.split(" ")[1];
  jwt.verify(tokenReceived, instance.get("jwtSecret"), function(err, decoded) {
    console.log("in verify");
    if (err) {
...
instance.delete("/api/person/delete", function(request, response) {
  var tokenReceived = request.headers.authorization.split(" ")[1];
  jwt.verify(tokenReceived, instance.get("jwtSecret"), function(err, decoded) {
    console.log("in verify");
    if (err) {
      ...
      request.decoded = decoded;
      deletePersonModel.deleteOne({PersonalUniqueId:request.body.PersonalUniqueId}, function(err, res) {
        if (err) {
          response.statusCode = 500;
          response.send({ status: response.statusCode, error: err });
        }
...
instance.delete("/api/tempperson/delete", function(request, response) {
  var tokenReceived = request.headers.authorization.split(" ")[1];
  jwt.verify(tokenReceived, instance.get("jwtSecret"), function(err, decoded) {
    console.log("in verify");
    if (err) {
      ...
      request.decoded = decoded;
      // console.log(prd);
      tempPersonModel.deleteOne({PersonalUniqueId:request.body.PersonalUniqueId}, function(err, res) {
        if (err) {
          response.statusCode = 500;
          response.send({ status: response.statusCode, error: err });
        }
...
// instance.put("/products/:id", function(request, response) {
//   // parsing posted data to JSON
//   var tokenReceived = request.headers.authorization.split(" ")[1];
//   jwt.verify(tokenReceived, instance.get("jwtSecret"), function(err, decoded) {
//     console.log("in verify");
...
//       };
//       productModel.updateOne(condition, prd, function(err, res) {
//         if (err) {
//           response.statusCode = 500;
//           response.send({ status: response.statusCode, error: err });
//         }
...
// instance.post("/products/create", function(request, response) {
//   var tokenReceived = request.headers.authorization.split(" ")[1];
//   jwt.verify(tokenReceived, instance.get("jwtSecret"), function(err, decoded) {
//     console.log("in verify");
//     if (err) {
